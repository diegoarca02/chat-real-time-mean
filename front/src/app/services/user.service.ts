...
Básicamente un servicio es un proveedor de datos que será consumido por los componentes para acceder a la información y la realización de operaciones con los datos.
